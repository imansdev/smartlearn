          ...
          <b-card-body :title="course.name">
            ...
            <b-row>
              <b-card-sub-title id="Cinformations" class="py-3 text-center">
                <div>Estimated Time {{ course.deadline }} Weeks &nbsp;&nbsp;<strong class="dividercolor">|</strong></div>
                <div>Language From {{ course.languageFrom }} &nbsp;&nbsp;<strong class="dividercolor">|</strong></div>
                <div>Language TO {{ course.languageTo }} &nbsp;&nbsp;<strong class="dividercolor">|</strong></div>
...
export default {
  ...
  methods:{
        createdAt() {
      const at = moment(this.course.createdAt);
      return at.fromNow();
    },
  }
};
